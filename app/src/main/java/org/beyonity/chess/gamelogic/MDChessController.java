 ...
 * @author petero
 */
public class MDChessController {
    ...
    /** Constructor. */
    public MDChessController(GUIInterface gui, PgnToken.PgnTokenReceiver gameTextListener,
            PGNOptions options) {
        this.gui = gui;
    ...
    private final class SearchListener implements org.beyonity.chess.gamelogic.SearchListener {
