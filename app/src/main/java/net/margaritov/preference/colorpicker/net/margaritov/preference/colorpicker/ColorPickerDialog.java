...
package net.margaritov.preference.colorpicker.net.margaritov.preference.colorpicker;
...
public class ColorPickerDialog
        ...
        Dialog
        implements
        net.margaritov.preference.colorpicker.ColorPickerView.OnColorChangedListener,
    ...
    private void setUp(int color) {
        ...
        mColorPicker = (net.margaritov.preference.colorpicker.ColorPickerView) findViewById(
                R.id.color_picker_view);
