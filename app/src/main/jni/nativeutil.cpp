...
/*
 * Class:     org_mdc_chess_engine_EngineUtil
 * Method:    chmod
 * Signature: (Ljava/lang/String;)Z
 */
extern "C" JNIEXPORT jboolean JNICALL Java_org_beyonity_chess_engine_EngineUtil_chmod
 ...
 * Signature: (II)V
 */
extern "C" JNIEXPORT void JNICALL Java_org_beyonity_chess_engine_EngineUtil_reNice
